    ...
    <div class="grid grid-cols-12 gap-8 pb-8">
        <div class="col-span-6">
            @if($activeCampaign)
                ...
                <a href="{{ URL::to($activeCampaign->slug.'?a='. auth()->user()->name.'&spin='. $activeCampaign->games_frequency) }}" target="_blank" class="text-xs">{{ URL::to($activeCampaign->slug.'?a='. auth()->user()->name.'&spin='. $activeCampaign->games_frequency) }}</a>
